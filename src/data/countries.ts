...
export const COUNTRIES: SafariCountry[] = [
  ...
  },
  {
    ...
    briefing: {
      ...
      stops: ["Bruxelles (Brussels Airlines)", "Addis Abeba (Ethiopian)", "Doha (Qatar)"],
      routing: "1 scalo · arrivo Kigali (KGL)",
  ...
  },
  {
    ...
    briefing: {
      ...
      stops: ["Diretto Roma–Nairobi (Kenya Airways)", "Doha (Qatar)", "Istanbul (Turkish)"],
      routing: "Diretto o 1 scalo · arrivo Nairobi (NBO)",
  ...
  },
  {
    ...
    briefing: {
      ...
      flightTime: "~9h da Italia (scalo)",
      stops: ["Doha (Qatar)", "Addis Abeba (Ethiopian)", "Istanbul (Turkish)"],
      routing: "1 scalo · arrivo Kilimanjaro (JRO) o Dar es Salaam (DAR)",
  ...
  },
  {
    ...
    briefing: {
      ...
      stops: ["Johannesburg (South African)", "Addis Abeba (Ethiopian)", "Doha (Qatar)"],
      routing: "1 scalo · arrivo Lusaka (LUN) o Livingstone (LVI)",
